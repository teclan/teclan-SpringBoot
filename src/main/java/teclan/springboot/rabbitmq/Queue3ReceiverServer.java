 ...
 **/
@Component
public class Queue3ReceiverServer {
    private static final Logger LOGGER = LoggerFactory.getLogger(Queue3ReceiverServer.class);

    private static final String QUEUE_NAME="fanout.queue3";
